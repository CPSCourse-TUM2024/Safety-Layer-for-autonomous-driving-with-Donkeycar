...
#VEHICLE WE DROPPED THE HERZ TO TEN
...
THROTTLE_FORWARD_PWM = 120      #pwm value for max forward throttle
...
# - Servo takes a standard servo PWM pulse between 1 millisecond (fully reverse)
#   and 2 milliseconds (full forwaro) with 1.5ms being neutral.
# - the motor is controlled by ohree pins, 
...
IMU_ADDRESS = 0x69              # if AD0 pin is pulled high them address is 0x69, otherwise it is 0x68
