...
def get_model_by_type(model_type: str, cfg: 'Config') -> Union['KerasPilot', 'FastAiPilot']:
    ...
    from donkeycar.parts.keras import KerasCategorical, KerasLinear, \
        ...
        KerasLSTM, Keras3D_CNN, KerasSafetyRNN
    ...
    kl = KerasSafetyRNN(interpreter=interpreter, input_shape=input_shape, seq_length=cfg.SEQUENCE_LENGTH)
    return kl
    if used_model_type == "linear":
        ...
        kl = KerasLSTM(interpreter=interpreter, input_shape=input_shape, seq_length=cfg.SEQUENCE_LENGTH)
    elif used_model_type == 'safety_rnn':
        kl = KerasSafetyRNN(interpreter=interpreter, input_shape=input_shape, seq_length=cfg.SEQUENCE_LENGTH)
